...
void greater_equal_u1u1( float* result, const float* lhs, const float* rhs, unsigned int /*length*/ )
{
    result[0] = lhs[0] >= rhs[0];
}

void greater_equal_u1v1( float* result, const float* lhs, const float* rhs, unsigned int length )
{
...
void greater_equal_v1u1( float* result, const float* lhs, const float* rhs, unsigned int length )
{
    for ( unsigned int i = 0; i < length; ++i )
    {
...
void greater_equal_v1v1( float* result, const float* lhs, const float* rhs, unsigned int length )
{
    for ( unsigned int i = 0; i < length; ++i )
    {
