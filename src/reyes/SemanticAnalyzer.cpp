...
void SemanticAnalyzer::analyze_multiply( SyntaxNode* node ) const
{
    ...
    {
        { FLOAT, FLOAT, TYPE_FLOAT, INSTRUCTION_MULTIPLY_FLOAT },
        { COLOR, COLOR, TYPE_COLOR, INSTRUCTION_MULTIPLY_VEC3 },
...
void SemanticAnalyzer::analyze_divide( SyntaxNode* node ) const
{
    ...
    {
        { FLOAT, FLOAT, TYPE_FLOAT, INSTRUCTION_DIVIDE_FLOAT },
        { COLOR, FLOAT, TYPE_COLOR, INSTRUCTION_DIVIDE_VEC3 },
        { POINT, FLOAT, TYPE_POINT, INSTRUCTION_DIVIDE_VEC3 },
        { NORMAL, FLOAT, TYPE_NORMAL, INSTRUCTION_DIVIDE_VEC3 },
...
void SemanticAnalyzer::analyze_add( SyntaxNode* node ) const
{
    ...
    {
        { FLOAT, FLOAT, TYPE_FLOAT, INSTRUCTION_ADD_FLOAT },
        { COLOR, COLOR, TYPE_COLOR, INSTRUCTION_ADD_VEC3 },
...
void SemanticAnalyzer::analyze_subtract( SyntaxNode* node ) const
{
    ...
    {
        { FLOAT, FLOAT, TYPE_FLOAT, INSTRUCTION_SUBTRACT_FLOAT },
        { COLOR, COLOR, TYPE_COLOR, INSTRUCTION_SUBTRACT_VEC3 },
        { POINT | NORMAL | VECTOR, POINT | NORMAL | VECTOR, TYPE_VECTOR, INSTRUCTION_SUBTRACT_VEC3 },
        { MATRIX, MATRIX, TYPE_MATRIX, INSTRUCTION_SUBTRACT_VEC3 }
    };
